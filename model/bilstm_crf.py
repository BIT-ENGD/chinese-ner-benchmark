...
## 参考模型：  https://gitee.com/shimii/BERT-BiLSTM-CRF-NER-pytorch/blob/master/models.py


## 代码注释： https://gitee.com/chenzhouwy/bert_bilstm_crf_ner_pytorch/blob/master/torch_ner/source/models.py
...
class BERT_BiLSTM_CRF_Ex(BertPreTrainedModel):

    def __init__(self, config, need_birnn=False, rnn_dim=128):
        super(BERT_BiLSTM_CRF_Ex, self).__init__(config)
